...
<body>
    <form action="${path}/boardReply.do" method="post" enctype="multipart/form-data"><!-- enctype 파일이나 이미지를 서버로 전송할 때 주로 사용 -->
    <div id="wrap">
        <header>
          답글 작성
        </header>
        ...
        <footer>  
            ...
            <input type="hidden" value="${sessionScope.memberInfo.id}" name="writer">
            <input type="submit" id="gotoList" value="답글작성">
        </footer>
    </div>
</form>
</body>
